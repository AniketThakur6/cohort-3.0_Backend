...
const ShortenForm = ({ setFormInput ,createUrl }) => {
  ...
  return (
    <div className="w-280">
      <form onSubmit={handleSubmit} className="flex p-1 gap-3 justify-center">
        ...
        <div className="flex gap-3 items-end">
          <button 
          type="submit"
          className="bg-amber-600 hover:bg-amber-700 transition-colors duration-250 flex gap-2 items-center cursor-pointer px-4 py-3 rounded-lg">
            <Link2 />
            Shorten
          </button>
